...
public abstract class AbstractDocumentView extends SurfaceView implements ZoomListener, IDocumentViewController, SurfaceHolder.Callback {
    ...
    public AbstractDocumentView(final IViewerActivity baseActivity) {
        ...
        this.align = PageAlign.AUTO;
        this.firstVisiblePage = -1;
        this.lastVisiblePage = -1;
        this.scroller = new Scroller(getContext());
        this.pageToGo = PageIndex.FIRST;
    ...
    protected void init() {
        ...
        if (getBase().getDocumentModel() != null) {
     ...
     * {@inheritDoc}
     *
     * @see com.smartmobilefactory.pdfviewer.pdfviewer.event.ebookdroid.core.events.ZoomListener#commitZoom()
     */
    @Override
    ...
    protected ViewState onZoomChanged(final float newZoom) {
    	...
    	if (getBase().getDocumentModel() != null) {
    		final ViewState viewState = calculatePageVisibility(getBase().getDocumentModel().getCurrentViewPageIndex(), 0,
    				newZoom);
     ...
     * {@inheritDoc}
     *
     * @see com.smartmobilefactory.pdfviewer.pdfviewer.event.ebookdroid.core.events.ZoomListener#zoomChanged(float, float)
     */
    @Override
...
//                        (int) -velocityTracker.getYVelocity(), l.left, l.right, l.top, l.bottom);
                getScroller().fling(getScrollX(), getScrollY(), 0,
                      0, l.left, l.right, l.top, l.bottom);
