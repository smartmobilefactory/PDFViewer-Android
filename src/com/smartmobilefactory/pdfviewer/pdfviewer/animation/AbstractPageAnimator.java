...
public abstract class AbstractPageAnimator implements PageAnimator {
    ...
    /**
     * @see com.smartmobilefactory.pdfviewer.animation.ebookdroid.core.curl.PageAnimator#onDraw(android.graphics.Canvas)
     */
    @Override
...
//                            view.getBase().getZoomModel().toggleZoomControls();
                            view.getBase().getPdfOverlayModel().togglePdfOverlay();
//                        }
                    } else {
