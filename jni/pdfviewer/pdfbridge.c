...
JNIEXPORT jlong JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfDocument_open
...
JNIEXPORT void JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfDocument_free
...
JNIEXPORT jint JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfDocument_getPageInfo(JNIEnv *env,
                                    jclass cls,
                                    jlong handle,
                                    jint pageNumber,
                                    jobject cpi)
...
JNIEXPORT jobject JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfDocument_getPageLinks
	...
	if(!error && page && page->links) {
	    ...
	    if(!arrayList)
	     ...
	     for (link = page->links; link; link = link->next)
	     {
	    	...
	    	jclass pagelinkClass = (*env)->FindClass(env,"com/smartmobilefactory/pdfviewer/pdfviewer/page/PageLink");
		if(!pagelinkClass)
		    return arrayList;
		...
		if (link->kind == PDF_LINK_URI)
		{
		    ...
		    snprintf(linkbuf,len + 1,"%s",fz_to_str_buf(link->dest));
		    linkbuf[len] = 0;
		}
...
JNIEXPORT jint JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfDocument_getPageCount
	(JNIEnv *env, jclass clazz, jlong handle)
{
	renderdocument_t *doc = (renderdocument_t*) (long)handle;
...
JNIEXPORT jlong JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfPage_open
...
JNIEXPORT void JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfPage_free
	(JNIEnv *env, jclass clazz, jlong handle)
{
...
JNIEXPORT void JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfPage_getMediaBox
...
JNIEXPORT jint JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfPage_getRotate
	(JNIEnv *env, jclass clazz, jlong handle)
{
	renderpage_t *page = (renderpage_t*) (long)handle;
...
JNIEXPORT void JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfPage_renderPage
...
JNIEXPORT jboolean JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfPage_isNativeGraphicsAvailable
...
JNIEXPORT jboolean JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfPage_renderPageBitmap
    (JNIEnv *env, jobject this, jlong dochandle, jlong pagehandle,
	jintArray viewboxarray, jfloatArray matrixarray,
	jobject bitmap)
{
...
//Outline
JNIEXPORT jlong JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfOutline_open
...
JNIEXPORT void JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfOutline_free
	(JNIEnv *env, jclass clazz, jlong dochandle)
{
	renderdocument_t *doc = (renderdocument_t*) (long)dochandle;
...
JNIEXPORT jstring JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfOutline_getTitle
...
JNIEXPORT jstring JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfOutline_getLink
...
JNIEXPORT jlong JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfOutline_getNext
	(JNIEnv *env, jclass clazz, jlong outlinehandle)
{
	pdf_outline *outline = (pdf_outline*) (long)outlinehandle;
...
JNIEXPORT jlong JNICALL
	Java_com_smartmobilefactory_pdfviewer_pdfviewer_PdfOutline_getChild
	(JNIEnv *env, jclass clazz, jlong outlinehandle)
{
	pdf_outline *outline = (pdf_outline*) (long)outlinehandle;
